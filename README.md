...
- [x] 通知渠道(钉钉/飞书/Server酱/Webhook)告警 + 每日巡检报告推送
- [x] 指标存储历史化 + 监控历史趋势(按天 JSONL, 保留 14 天)
- [x] 多用户与角色权限(RBAC: 管理员/只读)
- [x] 凭据加密 at-rest(AES-256-GCM, 主密钥本地托管)
- [x] Ansible 自动化 / CI 工具链 / 网络安全工具集
- [ ] 代码运行沙箱化(容器/隔离)
- [ ] 邮件(SMTP)通知渠道
- [ ] OpenAPI 导出与 CLI
